...
//Aplicado o segundo princípio do SOLID (Princípio Aberto-Fechado), a classe PuroMalte estende da classe Validade.
//Aplicado o quarto princípio do SOLID (Princípio da Segregação da Interface), interface MetodCerveja é implementada na PuroMalte.
